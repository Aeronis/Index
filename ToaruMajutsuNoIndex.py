...
#-----#
if (len(XXX) > 10): #Len means 'length' of the input value
  print("This value is very long")
elif (len(XXX) > 6): #'Else If' is a way to add other declarable values to an if statement
...
#-----#
for value in range(1, 10, 1): #Lists out numbers X to X in incriments of X
  #1-10 is range and 1 is incriment
  print(value)
while (iterations < XXX): #Will print XXX Y times, depending on the user input
  Print("Word")
  iterations = iterations + 1 #Control variable
#-----#